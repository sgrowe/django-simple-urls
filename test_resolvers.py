...
from .resolvers import simple_url, _construct_regex, _validate_path_piece_name, _pattern_for_path_piece
import re
...
class PatternForPathPieceTests(SimpleTestCase):
    def test_returns_valid_regex_patterns(self):
        ...
        for piece_type in valid_types:
            ...
            re.compile(regex)  # Will raise exception if regex is invalid
